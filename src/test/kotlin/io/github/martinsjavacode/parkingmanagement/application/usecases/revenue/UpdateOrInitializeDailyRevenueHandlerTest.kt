...
class UpdateOrInitializeDailyRevenueHandlerTest : DescribeSpec({
    ...
    val handler = UpdateOrInitializeDailyRevenueHandlerImpl(
    ...
    describe("UpdateOrInitializeDailyRevenueHandler") {
        ...
        it("should return null when parking id is null") {
            ...
            coEvery { parkingCustomQueryRepository.findParkingByCoordinates(latitude, longitude) } returns parkingWithoutId
