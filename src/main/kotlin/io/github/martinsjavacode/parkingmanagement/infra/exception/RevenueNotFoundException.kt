...
/**
 * Exception thrown when a revenue record is not found.
 *
 * This exception is raised when a query is made for a revenue
 * record that is not registered in the system.
 *
